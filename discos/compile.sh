...
gcc -std=gnu99 -c fs_helper_nir.c -o fs_helper_nir.o -fno-stack-protector
...
ld -T memos-2.ld osdev.o switch_thread.o memos-2.o  output.o thread.o scheduler.o descriptor_table.o table.o helper.o timer.o fs.o fs_helper.o fs_func.o fs_debug.o fs_helper_nir.o -o memos-2
rm *.o
#objdump -D memos-2 > a
#vim a
